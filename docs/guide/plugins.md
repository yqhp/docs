...
| yqhp | yqhp-easyimg | 图片识别 api                                        | [easyimg-plugin-0.0.4.jar](http://139.9.5.56:9000/yqhp-res/easyimg-plugin-0.0.4.jar) <br> [common-opencv-0.0.2.jar](http://139.9.5.56:9000/yqhp-res/common-opencv-0.0.2.jar) | [查看](#yqhp-easyimg) |
